...
(function($) {
	$.fn.html5lightbox = function(options) {
				...
				.extend(
						{
							...
							freelink : "../html5box.com/default.htm",
							watermark : "",
							watermarklink : ""
						}, options);
		...
		if (inst.options.skinfolder.charAt(0) != "default.htm"
		...
		inst.createMarkup = function() {
			var fontRef = ("https:" == document.location.protocol ? "https"
					: "http")
					+ "_3A//fonts.googleapis.com/css@family=Armata";
					...
					.resizeLightbox(
							...
							function() {
								...
								if (isHTML5) {
									...
									if (videoFile.charAt(0) != "default.htm"
